...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{minipage}[c][.6\textheight][c]{\linewidth}
      ...
      \begin{tabular}{ll}
        $i$      & \texttt{\alert<3>{1}\alert<4>{2}\alert<5>{3}\alert<6>{4}\alert<7>{5}678}\\
        \hline
        chaîne & \verb!atalata\$!\\
      ...
      \alert<6>{i = 4} ; Rank[i] = 5 ; j ← 7\\
      ~ ~ ~ A[4] = A[7] ? Non $\Rightarrow$ Height[5] ← 0\\
      \\ \\ \\
      }\only<7>{h = 0\\
      \alert<7>{i = 5} ; Rank[5] = 3 ; j ← 1\\
