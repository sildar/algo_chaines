...
\begin{frame}
  ...
  \begin{block}
  Le \textit{lcp} de deux sous-chaînes est le minimum des lcp de toutes les
  sous-chaînes adjacentes dans l'intervalle.
  \end{block}
  \begin{block}
...
\begin{frame}
  \frametitle{Algorithme GetHeight}
  \begin{block}{Comment calculer \textit{Height[q]} à partir de
    \textit{Height[p]}~?}
  \end{block}
\end{frame}
